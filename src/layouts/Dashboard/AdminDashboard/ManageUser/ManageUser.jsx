        ...
        <div className="p-6">
            ...
            {users.length === 0 && (
                <div className="flex flex-col items-center justify-center py-20 bg-white shadow-md rounded-xl mx-5 md:mx-auto max-w-md">
                    ...
                    <button onClick={() => navigate('/dashboard')} className="px-6 py-3 bg-linear-to-r from-purple-400 to-indigo-500 hover:from-indigo-500 hover:to-purple-400 text-white font-semibold rounded-full shadow-lg transition duration-300">
                        Dashboard ✉️
                    </button>
                </div>
            )}
